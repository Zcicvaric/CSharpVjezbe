...
namespace Labs
{
	...
	public class AppForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.menuItem2.Text = "New Summary View";
		...
		private void menuItem2_Click(object sender, EventArgs e)
		{
			...
			summaryForm.Location = new Point(NEW_VIEW_START_X_POS, NEW_VIEW_START_Y_POS);
			summaryForm.Text = "Summary View " + VIEW_COUNTER;
