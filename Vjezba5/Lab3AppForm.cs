...
namespace Labs
{
	...
	public class Lab3AppForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.Text = "Lab3";
            this.Load += new System.EventHandler(this.Lab3AppForm_Load);
		...
		private void showSquareData_Click(object sender, System.EventArgs e)
		{
			...
			string message = "";
			message += "Side of square=" + square.getSide();
		...
		private void showTriangleData_Click(object sender, System.EventArgs e)
		{
			...
			string message = "";
			message += "Side of triangle=" + triangle.getSide();
		...
		private void Lab3AppForm_Load(object sender, EventArgs e)
		{
